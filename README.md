...
### 1. Рисование комнаты
![Рисование комнаты](https://github.com/yvd230670-rgb/tile-layout-planner/raw/main/images/screenshot-1-1-room.png)
![Рисование комнаты](https://github.com/yvd230670-rgb/tile-layout-planner/raw/main/images/screenshot-1-2-room.png)

### 2. Настройки плитки
![Настройки плитки](https://github.com/yvd230670-rgb/tile-layout-planner/raw/main/images/screenshot-2-settings.png)

### 3. Прямая раскладка (600×600)
![Прямая раскладка](https://github.com/yvd230670-rgb/tile-layout-planner/raw/main/images/screenshot-3-straight.png)

### 4. Поперечная раскладка (1200×600)
![Поперечная раскладка](https://github.com/yvd230670-rgb/tile-layout-planner/raw/main/images/screenshot-4-transverse.png)

### 5. Диагональная раскладка
![Диагональная раскладка](https://github.com/yvd230670-rgb/tile-layout-planner/raw/main/images/screenshot-5-diagonal.png)
...
**Комната 30,9 м.кв, плитка 600×600, шов 3 мм.**

1. Рисуем комнату сложной формы.
2. Настройки: Длина `600`, Ширина `600`, Шов `3`, Раскладка **Прямая**.
3. Режим плитки → **60 целых плиток**, 19 с подрезкой.

![Прямая раскладка](images/screenshot-3-straight.png)

---

## 🎯 Пример 2: Прямоугольная плитка 1200×600

**Комната 30,9 м.кв, плитка 1200×600, шов 5 мм.**

1. Рисуем комнату сложной формы.
2. Настройки: Длина `1200`, Ширина `600`, Шов `5`, Раскладка **Поперечная**.
3. Режим плитки → **30 целых плиток**, 14 с подрезкой.

**Сравни с прямой раскладкой:** при **поперечной** — 30 целых плиток 1200×600, при **прямой** - 60 целых плиток 600×600. Выбирай, что красивее и выгоднее!
